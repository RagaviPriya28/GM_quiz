...
const AdminQuizPage = () => {
  ...
  return (
    <div className="p-4 bg-gray-100 min-h-screen">
      <div className="bg-white rounded-lg shadow-lg mx-2 sm:mx-4 lg:mx-10">
        <div className="flex flex-col lg:flex-row justify-between p-4 sm:p-6 space-y-6 lg:space-y-0">
          <div className="lg:w-1/2 space-y-4">
            <div className="flex justify-center">
              <img src={logo} alt="Quiz Admin Logo" className="w-32 h-auto mx-auto" />
            </div>
            <div className="flex justify-center mt-4 sm:mt-6">
              <button 
                onClick={handleStartQuiz}
                disabled={startingQuiz || !registeredUsers.length}
                className={`w-full sm:w-auto px-4 py-2 rounded-md transition duration-200 ${
          ...
          <div className="lg:w-1/2 space-y-4">
            <div className="text-center">
              <h2 className="text-xl font-bold mb-2 sm:mb-4">Quiz Registration QR Code</h2>
              {qrLoading ? (
                ...
                <>
                  <img 
                    ...
                    className="mx-auto w-48 h-48 sm:w-64 sm:h-64 border rounded-lg shadow-md"
                  />
            ...
            <div className="border-t pt-4 sm:pt-6">
              ...
              {error && (
                <p className="text-red-500 text-center mb-2 sm:mb-4">{error}</p>
              )}
              <div className="bg-gray-50 p-2 sm:p-4 rounded-lg max-h-[300px] sm:max-h-[400px] overflow-y-auto">
                {loading ? (
